...
class DetailPilkada extends StatefulWidget {
  final Datum? data;

  const DetailPilkada(this.data, {Key? key}) : super(key: key);

  @override
  State<DetailPilkada> createState() => _DetailPilkadaState();
}

class _DetailPilkadaState extends State<DetailPilkada> {
