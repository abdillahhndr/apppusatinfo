...
class ListPengaduanpegawai extends StatefulWidget {
  const ListPengaduanpegawai({super.key});

  @override
  State<ListPengaduanpegawai> createState() => _ListPengaduanpegawaiState();
}

class _ListPengaduanpegawaiState extends State<ListPengaduanpegawai> {
  ...
  Future<List<Datum>?> getJms() async {
    try {
      ...
      http.Response res =
          await http.post(Uri.parse('$url/pengaduanpegawai.php'), body: {
        "id_user": id,
      });
