...
import 'package:apppusatinfo/screens/admin/screen_detailjmsadmin.dart';
...
class ListJmsAdmin extends StatefulWidget {
  const ListJmsAdmin({super.key});

  @override
  State<ListJmsAdmin> createState() => _ListJmsAdminState();
}

class _ListJmsAdminState extends State<ListJmsAdmin> {
  ...
  Future<List<Datum>?> getJms() async {
    try {
      ...
      http.Response res = await http.get(Uri.parse('$url/jaksaadmin.php'));
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DetailJmsAdmin(data)));
                    },
                    child: Card(
