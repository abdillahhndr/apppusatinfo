...
import 'package:apppusatinfo/screens/admin/screen_detailkorupadmin.dart';
...
class ListKorupAdmin extends StatefulWidget {
  const ListKorupAdmin({super.key});

  @override
  State<ListKorupAdmin> createState() => _ListKorupAdminState();
}

class _ListKorupAdminState extends State<ListKorupAdmin> {
  ...
  Future<List<Datum>?> getJms() async {
    try {
      ...
      http.Response res = await http.get(Uri.parse('$url/gettkorupadmin.php'));
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DetailKorupAdmin(data)));
                    },
                    child: Card(
