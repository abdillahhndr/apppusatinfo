...
import 'package:apppusatinfo/screens/admin/screem_detailaliranadmin.dart';
import 'package:apppusatinfo/screens/edit/screen_editaliran.dart';
import 'package:apppusatinfo/screens/screem_detailaliran.dart';
...
class ListAliranagamaAdmin extends StatefulWidget {
  const ListAliranagamaAdmin({super.key});

  @override
  State<ListAliranagamaAdmin> createState() => _ListAliranagamaAdminState();
}

class _ListAliranagamaAdminState extends State<ListAliranagamaAdmin> {
  ...
  Future<List<Datum>?> getJms() async {
    try {
      ...
      http.Response res =
        ...
        "kategori": 'aliranagama',
        // "status": 'pending',
      });
      List<Datum> data = modelListPhkmFromJson(res.body).data ?? [];
      setState(() {
        _allJms = data;
      });
    } catch (e) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text(
            "List Pengawasan Aliran Agama dan Kepercayaan",
            style: TextStyle(
              fontSize: 24,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DetailAliranAdmin(data)));
                    },
                    child: Card(
