...
import 'package:apppusatinfo/screens/admin/screen_detailpilkadaadmin.dart';
import 'package:apppusatinfo/screens/edit/screen_editpilkada.dart';
import 'package:apppusatinfo/screens/screen_detailpilkada.dart';
...
class ListPoskoAdmin extends StatefulWidget {
  const ListPoskoAdmin({super.key});

  @override
  State<ListPoskoAdmin> createState() => _ListPoskoAdminState();
}

class _ListPoskoAdminState extends State<ListPoskoAdmin> {
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DetailPilkadaAdmin(data)));
                    },
                    child: Card(
