...
import 'package:apppusatinfo/screens/admin/screen_detailphkmadmin.dart';
import 'package:apppusatinfo/screens/edit/screen_editphkm.dart';
import 'package:apppusatinfo/screens/screen_detailphkm.dart';
...
class ListPhkmAdmin extends StatefulWidget {
  const ListPhkmAdmin({super.key});

  @override
  State<ListPhkmAdmin> createState() => _ListPhkmAdminState();
}

class _ListPhkmAdminState extends State<ListPhkmAdmin> {
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DetailPhkmAdmin(data)));
                    },
                    child: Card(
