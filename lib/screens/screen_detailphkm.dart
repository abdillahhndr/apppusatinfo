...
class DetailPhkm extends StatefulWidget {
  final Datum? data;

  const DetailPhkm(this.data, {Key? key}) : super(key: key);

  @override
  State<DetailPhkm> createState() => _DetailPhkmState();
}

class _DetailPhkmState extends State<DetailPhkm> {
