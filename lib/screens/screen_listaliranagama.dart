...
class ListAliranagama extends StatefulWidget {
  const ListAliranagama({super.key});

  @override
  State<ListAliranagama> createState() => _ListAliranagamaState();
}

class _ListAliranagamaState extends State<ListAliranagama> {
  ...
  Future<List<Datum>?> getJms() async {
    try {
      ...
      http.Response res =
          await http.post(Uri.parse('$url/aliranagama.php'), body: {
        "id_user": id,
      });
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DetailAliran(data)));
                    },
                    child: Card(
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => PengawasanaliranPage()));
          },
