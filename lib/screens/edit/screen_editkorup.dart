...
class EditKorup extends StatefulWidget {
  Datum? data;
  EditKorup(this.data, {super.key});

  @override
  State<EditKorup> createState() => _EditKorupState();
}

class _EditKorupState extends State<EditKorup> {
  ...
  TextEditingController txtUraiansingkat = TextEditingController();
  ...
  Future<void> addpeg(String idk) async {
    try {
      setState(() {
        isLoading = true;
      });
      ...
      if (fileKtp != null && fileLaporan != null) {
        ...
        if (data.isSuccess) {
          ...
          Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(builder: (context) => const ListKorup()),
            (route) => false,
          );
        } else {
          ScaffoldMessenger.of(context)
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text(
              "Edit Pengaduan Tindak Pidana Korupsi",
              style: TextStyle(
                fontSize: 24,
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: widget.data!.uraianLaporan,
                      ),
                    ),
                    SizedBox(
                      height: 24,
