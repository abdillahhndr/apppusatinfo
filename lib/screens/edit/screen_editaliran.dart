...
class EditAliran extends StatefulWidget {
  Datum? data;
  EditAliran(this.data, {super.key});

  @override
  State<EditAliran> createState() => _EditAliranState();
}

class _EditAliranState extends State<EditAliran> {
  ...
  Future<void> addpeg(String idp) async {
    try {
      ...
      if (fileKtp != null && fileLaporan != null) {
        ...
        request.fields['kategori'] = 'aliranagama';
