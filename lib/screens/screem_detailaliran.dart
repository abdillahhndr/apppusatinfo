...
class DetailAliran extends StatefulWidget {
  final Datum? data;

  const DetailAliran(this.data, {Key? key}) : super(key: key);

  @override
  State<DetailAliran> createState() => _DetailAliranState();
}

class _DetailAliranState extends State<DetailAliran> {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Detail Pengawasan Aliran dan Kepercayaan",
                    style: TextStyle(
                      fontSize: 24,
