...
class PengaduankorupPage extends StatefulWidget {
  const PengaduankorupPage({super.key});

  @override
  State<PengaduankorupPage> createState() => _PengaduankorupPageState();
}

class _PengaduankorupPageState extends State<PengaduankorupPage> {
    ...
    try {
      ...
      if (fileKtp != null && fileLaporan != null) {
        var request = http.MultipartRequest(
            'POST', Uri.parse('$url/addpengaduankorupsi.php'));
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Uraikan Singkat Laporan',
                      ),
                    ),
                    SizedBox(
                      height: 24,
