...
class ListPhkm extends StatefulWidget {
  const ListPhkm({super.key});

  @override
  State<ListPhkm> createState() => _ListPhkmState();
}

class _ListPhkmState extends State<ListPhkm> {
  ...
  Future<List<Datum>?> getJms() async {
    try {
      ...
      http.Response res =
          await http.post(Uri.parse('$url/penyuluhan.php'), body: {
        "id_user": id,
      });
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DetailPhkm(data)));
                    },
                    child: Card(
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => PenyuluhanhukumPage()));
          },
