...
class ListPosko extends StatefulWidget {
  const ListPosko({super.key});

  @override
  State<ListPosko> createState() => _ListPoskoState();
}

class _ListPoskoState extends State<ListPosko> {
  ...
  Future<List<Datum>?> getJms() async {
    try {
      ...
      http.Response res =
          await http.post(Uri.parse('$url/poskopilkada.php'), body: {
        "id_user": id,
      });
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DetailPilkada(data)));
                    },
                    child: Card(
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (context) => PoskopilkadaPage()));
          },
